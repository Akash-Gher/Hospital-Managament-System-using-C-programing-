//NASA Hospital Management system 
//Designed by:Team NASA 
//Subject:Software Engineering practical mini project
//Team members:  1.Nikita 2.Akash 3.Saurabh 4.Ankit
//class:CSE 3rd year
...
void main()
{
	...
	textcolor(15);
	lowvideo();gotoxy(22,10);textcolor(14);
	cprintf("Enter the corresponding no");gotoxy(22,14);textcolor(10);
	cprintf("1.Add new patient record");gotoxy(22,16);
	cprintf("2.Search  or edit record");gotoxy(22,18);
	cprintf("3.Know the records of patients");gotoxy(22,20);
	cprintf("4.Delete the records");gotoxy(22,22);
	cprintf("5.Exit from the program");gotoxy(22,24);
	fflush(stdin);
	scanf("%c",&d);
	switch(d)
	{
		case '1':
			...
			mainscreen();
			label:
			gotoxy(20,18);textcolor(7);
			cprintf("1.Enter `o' for O.P.D.(Out patient Department)");
			gotoxy(20,20);textcolor(7);
			cprintf("2.Enter `e'for Emergency");
			gotoxy(35,21);
			fflush(stdin);
			scanf("%c",&c);
			if(c=='o')
		...
		case '5':
			...
			clrscr();
			mainscreen();
			textcolor(14); gotoxy(18,13);

		       //	cprintf("SAVING UR SETTINGS"); gotoxy(30,28);
			cprintf("*******Daveloped By Team NASA********\n");
			printf("\n\tDavelopers:\n\n\t1.Nikita\n\t2.Akash\n\t3.Saurabh\n\t4.Ankit\n");
			cprintf("\n                  Thank you............\n");gotoxy(19,15);
			getch();
			exit(1);
		...
		case '3':
			{       label6:
				...
				cprintf("1.Records of patients in alphabatecal order");gotoxy(22,16);
				cprintf("2.Records of Emergency patients");gotoxy(22,18);
				cprintf("3.Records of O.P.D. patients");gotoxy(22,20);
				cprintf("4.Recordsin paricular date");gotoxy(22,22);
				cprintf("5.Return to main menu");gotoxy(25,24);
				fflush(stdin);
				scanf("%c",&d);
				switch(d)
				{
...
void mainscreen()
{
	...
	cprintf("NASA HOSPITAL");
	gotoxy(27,6);textcolor(6);
	cprintf("  BIT, Ballarpur");
